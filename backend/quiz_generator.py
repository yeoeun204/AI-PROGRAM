...
3. easy 2개, medium 2개, hard 1개를 만들어주세요.
    ...
    try:
        response = await client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"다음 내용을 바탕으로 주관식 문제 {count}개를 생성하세요:\n\n{content_trimmed}"},
            ],
        )
        ...
        # JSON 파싱 실패 시 기본 퀴즈 1개라도 저장
        print(f"퀴즈 생성 오류: {e}")
        quiz_list = [
            {
                "question": "이 강의 자료의 핵심 개념을 설명하고, 그 중요성을 서술하세요.",
                "model_answer": "강의 자료의 핵심 개념을 이해하고 그 의미와 중요성을 자신의 말로 설명할 수 있어야 합니다.",
                "key_points": ["핵심 개념", "중요성", "적용"],
                "difficulty": "medium",
            }
        ]
